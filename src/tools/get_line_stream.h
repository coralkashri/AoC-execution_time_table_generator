...
static bool get_line_stream(std::istream &input, std::stringstream &output, char delimiter) {
...
static bool get_line_stream(std::istream &input, std::stringstream &output) {
